...
\midrule[1pt]
网易新闻 & 68.0\%/51.5\% & 96.9\%/93.9\% & \textbf{97.9\%}/\textbf{95.9\%} & 96.7\%/93.7\% \\
央视网新闻 & 80.4\%/67.3\% & 95.8\%/91.9\% & \textbf{99.1\%}/\textbf{98.3\%} & 96.7\%/93.7\% \\
凤凰资讯 & 50.8\%/34.0\% & 99.5\%/99.1\% & 95.6\%/91.6\% & \textbf{99.7\%}/\textbf{99.4\%} \\
腾讯新闻 & 80.0\%/66.7\% & 96.4\%/93.0\% & \textbf{96.9\%}/\textbf{93.9\%} & 96.6\%/93.4\% \\
新浪新闻 & 81.2\%/68.4\% & \textbf{98.1\%}/96.2\% & 93.6\%/88.0\% & \textbf{98.1\%}/\textbf{96.3\%} \\
搜狐新闻 & 73.0\%/57.4\% & \textbf{98.6\%}/\textbf{97.3\%} & 96.0\%/92.3\% & 97.6\%/95.4\% \\
中国军网 & 89.6\%/81.2\% & 98.6\%/97.3\% & 97.1\%/94.3\% & \textbf{98.8\%}/\textbf{97.6\%} \\
参考消息 & 44.9\%/28.9\% & \textbf{99.8\%}/\textbf{99.7\%} & 92.6\%/86.3\% & 95.3\%/91.1\% \\
中国信息网 & 86.5\%/76.2\% & \textbf{99.0\%}/\textbf{98.1\%} & 98.9\%/97.8\% & \textbf{99.0\%}/98.0\% \\
央广网 & 85.6\%/74.8\% & 98.5\%/97.1\% & 92.0\%/85.2\% & \textbf{98.6\%}/\textbf{97.2\%} \\
环球网 & 74.7\%/59.6\% & 92.1\%/85.3\% & \textbf{97.0\%}/\textbf{94.3\%} & 93.7\%/88.1\% \\
人民网 & 85.9\%/75.3\% & 96.9\%/93.9\% & 89.6\%/81.2\% & \textbf{97.6\%}/\textbf{95.3\%} \\
...
联合早报 & 0.0\%/0.0\% & 96.6\%/93.3\% & 91.3\%/84.0\% & \textbf{98.3\%}/\textbf{96.7\%} \\
新闻 & 74.1\%/58.9\% & \textbf{97.4\%}/94.9\% & 95.6\%/91.6\% & \textbf{97.4\%}/\textbf{95.0\%} \\
\hline
网易博客 & 26.7\%/15.4\% & 53.4\%/36.4\% & 17.4\%/9.5\% & \textbf{86.7\%}/\textbf{76.6\%} \\
财经网博客 & 85.1\%/74.1\% & 93.7\%/88.2\% & 94.0\%/88.6\% & \textbf{96.1\%}/\textbf{92.5\%} \\
中金博客 & 57.3\%/40.2\% & 87.0\%/76.9\% & 62.1\%/45.0\% & \textbf{88.0\%}/\textbf{78.5\%} \\
东方财富博客 & 62.0\%/45.0\% & 87.9\%/78.4\% & 92.1\%/85.3\% & \textbf{95.2\%}/\textbf{90.8\%} \\
和讯博客 & 50.8\%/34.0\% & 87.6\%/77.9\% & 82.7\%/70.4\% & \textbf{96.8\%}/\textbf{93.9\%} \\
凤凰博客 & 65.7\%/49.0\% & \textbf{96.4\%}/\textbf{93.1\%} & 89.3\%/80.7\% & 95.3\%/91.1\% \\
瑞丽博客 & 59.8\%/42.6\% & 88.4\%/79.2\% & 88.8\%/79.9\% & \textbf{91.6\%}/\textbf{84.5\%} \\
科学网博客 & 64.7\%/47.9\% & 89.4\%/80.8\% & 91.0\%/83.6\% & \textbf{94.9\%}/\textbf{90.3\%} \\
新浪博客 & 71.3\%/55.3\% & \textbf{90.0\%}/81.8\% & 86.4\%/76.1\% & \textbf{90.0\%}/\textbf{81.9\%} \\
搜狐博客 & 74.9\%/59.8\% & 93.1\%/87.0\% & 86.0\%/75.4\% & \textbf{93.4\%}/\textbf{87.6\%} \\
天涯博客 & 82.7\%/70.4\% & \textbf{98.9\%}/\textbf{97.8\%} & 91.3\%/83.9\% & 95.8\%/91.9\% \\
博客大巴 & 77.2\%/62.9\% & 95.4\%/91.2\% & \textbf{97.1\%}/\textbf{94.4\%} & 95.7\%/91.8\% \\
博客中国 & 90.2\%/82.2\% & 98.3\%/96.7\% & 93.6\%/88.0\% & \textbf{99.0\%}/\textbf{98.0\%} \\
博客网 & 80.1\%/66.8\% & 95.6\%/91.5\% & 86.9\%/76.8\% & \textbf{96.6\%}/\textbf{93.5\%} \\
博客日报 & 82.8\%/70.7\% & \textbf{97.2\%}/\textbf{94.5\%} & 96.5\%/93.2\% & 95.7\%/91.7\% \\
博客 & 64.3\%/47.4\% & 88.9\%/80.0\% & 83.9\%/72.3\% & \textbf{94.4\%}/\textbf{89.4\%} \\
\hline
总体 & 68.8\%/52.4\% & 92.8\%/86.6\% & 89.5\%/81.1\% & \textbf{95.8\%}/\textbf{92.0\%} \\
\bottomrule[1.5pt]
\end{tabular}
\end{table}
...
coordinates{(News, 60.7) (Blog, 51.0) (Average, 55.4)};
\addplot[color=green, mark=triangle*, dashed]
coordinates{(News, 95.3) (Blog, 85.6) (Average, 90.1)};
\addplot[color=orange, mark=otimes*, thick]
coordinates{(News, 92.7) (Blog, 85.7) (Average, 89.2)};
...
\addplot[color=blue, mark=square*, dashed]
coordinates{(News, 95.1) (Blog, 86.9) (Average, 90.8)};
\addplot[color=green, mark=triangle*, dashed]
coordinates{(News, 99.6) (Blog, 92.4) (Average, 95.8)};
\addplot[color=orange, mark=otimes*, thick]
coordinates{(News, 98.7) (Blog, 82.2) (Average, 89.9)};
\addplot[color=red, mark=o, thick]
...
\addplot[color=blue, mark=square*, dashed]
coordinates{(News, 74.1) (Blog, 64.3) (Average, 68.8)};
\addplot[color=green, mark=triangle*, dashed]
coordinates{(News, 97.4) (Blog, 88.9) (Average, 92.8)};
\addplot[color=orange, mark=otimes*, thick]
coordinates{(News, 95.6) (Blog, 83.9) (Average, 89.5)};
\addplot[color=red, mark=o, thick]
...
\addplot[color=blue, mark=square*, dashed]
coordinates{(News, 58.9) (Blog, 47.4) (Average, 52.4)};
\addplot[color=green, mark=triangle*, dashed]
coordinates{(News, 94.9) (Blog, 80.0) (Average, 86.6)};
\addplot[color=orange, mark=otimes*, thick]
coordinates{(News, 91.6) (Blog, 72.3) (Average, 81.1)};
\addplot[color=red, mark=o, thick]
